...
export default function Compra7() {
    return (
<div className="tudo">
...
<div className="partedecima">
    <div className="direcao">
        <Link className="links" to='/'><h2>Home</h2></Link><h2>→</h2><Link className="links" to='/brincos'><h2>Brincos</h2></Link><h2>→</h2><h2>Brinco argola</h2>
    </div>
</div>
    <div className="site">
        <img className="foto" src="brinco1.jpg" alt="" />
        <div className="txt">
        <Link className="colecao" to='/brinco'><h3 className="tits">Coleção brincos</h3></Link>
        <h1 className="tit">brinco argola line em prata 925</h1>
