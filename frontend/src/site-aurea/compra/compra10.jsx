...
export default function Compra10() {
    return (
<div className="tudo">
...
<div className="partedecima">
    <div className="direcao">
        <Link className="links" to='/'><h2>Home</h2></Link><h2>→</h2><Link className="links" to='/brincos'><h2>Brincos</h2></Link><h2>→</h2><h2>Brinco em prata</h2>
    </div>
</div>
    <div className="site">
        <img className="foto" src="brinco4.jpg" alt="" />
        <div className="txt">
        <Link className="colecao" to='/brinco'><h3 className="tits">Coleção brincos</h3></Link>
        <h1 className="tit">brinco em prata 925 com perola<br />e topazios incolores </h1>
