...
export default function Compra23() {
    return (
<div className="tudo">
...
<div className="partedecima">
    ...
    <div className="site">
        <img className="foto" src="puls5.jpg" alt="" />
        <div className="txt">
        <Link className="colecao" to='/pulseira'><h3 className="tits">Coleção Pulseiras</h3></Link>        <h1 className="tit">pulseira mykonos em prata <br /> com ouro amarelo </h1>
