...
export default function Compra5() {
    return (
<div className="tudo">
...
<div className="partedecima">
    <div className="direcao">
        <Link className="links" to='/'><h2>Home</h2></Link><h2>→</h2><Link className="links" to='/anel'><h2>Aneis</h2></Link><h2>→</h2><h2>Anel kyra</h2>
    </div>
</div>
    <div className="site">
        <img className="foto" src="aneln3.jpg" alt="" />
        <div className="txt">
        <Link className="colecao" to='/anel'><h3 className="tits">Coleção aneis</h3></Link>
        <h1 className="tit">anel kyra em ouro branco com<br />diamantes</h1>
