...
export default function Compra24() {
    return (
<div className="tudo">
...
<div className="partedecima">
    <div className="direcao">
        <Link className="links" to='/'><h2>Home</h2></Link><h2>→</h2><Link className="links" to='/pulseira'><h2>Pulseiras</h2></Link><h2>→</h2><h2>Pulseira corda</h2>
    </div>
</div>
    <div className="site">
        <img className="foto" src="puls6.jpg" alt="" />
        <div className="txt">
        <Link className="colecao" to='/pulseira'><h3 className="tits">Coleção Pulseiras</h3></Link>        <h1 className="tit">pulseira corda em ouro amarelo </h1>
