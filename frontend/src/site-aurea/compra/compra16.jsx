...
export default function Compra16() {
    return (
<div className="tudo">
...
<div className="partedecima">
    <div className="direcao">
        <Link className="links" to='/'><h2>Home</h2></Link><h2>→</h2><Link className="links" to='/colar'><h2>Colares</h2></Link><h2>→</h2><h2>Colar chains</h2>
    </div>
</div>
    <div className="site">
        <img className="foto" src="cor3.jpg" alt="" />
        <div className="txt">
