    ...
    <div className='todo'>
        ...
        <br />
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra20'><p className='texto22'>
                    ...
                    PULSEIRA RIVEIRA EM OURO BRANCO 18K COM DIAMANTES       <br /><br />
         <br />
                    R$ 30,750,00        </p>
                    </Link>
                </div>
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra21'><p className='texto22'>
                    ...
                    PULSEIRA ARPEGE EM OURO BRANCO 18K COM DIAMANTES           <br /><br />
              <br />
                    R$ 44,500,00     </p>
                    </Link>
                </div>
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra23'><p className='texto22'>
                    ...
                    PULSEIRA MYKONOS EM PRATA 925 COM OURO AMARELO 18K      <br /> <br />
                     <br />
                    R$ 3,000,00        </p>
                    </Link>
                </div>
        ...
        <div className='cards2'>
                <div><Link className='likkm' to='/compra24'><p className='texto22'>
                    ...
                    PULSEIRA CORDA EM OURO AMARELO 18K        <br /><br />
                          <br />
