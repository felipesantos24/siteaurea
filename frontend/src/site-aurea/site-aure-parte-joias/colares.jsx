        ...
        <div className='cardsgeral'>
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra13'><p className='texto22'>
                    ...
                    COLAR ICONA EM OURO AMARELO 18K COM TURMALINA VERDE E DIAMANTES         <br />
                <br />
                    R$ 9,450,00       </p>
                    </Link>
                </div>
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra14'><p className='texto22'>
                    ...
                    COLAR RELIGIOSO ESTRELA DE DAVI EM OURO AMARELO 18K COM TOPAZIOS         <br />
                  <br />
                    R$ 4,950,00        </p>
                    </Link>
                </div>
            ...
            <div className='parte2'>
                ...
                <div><Link className='likkm' to='/compra16'><p className='texto22'>
                    ...
                    COLAR CHAINS EM PRATA 925 COM TOPAZIOS LONDON E SAFIRAS INCOLORES        <br /><br />
                     <br />
                    R$ 4,750,00     </p>
                    </Link>
                </div>
            ...
            <div className='cards2'>
                <div><Link className='likkm' to='/compra17'><p className='texto22'>
                    ...
                    COLAR MELODIA EM PRATA 925 COM RUBIS E ESPINELIOS        <br /><br /><br />
                      <br />
                    R$ 3,890,00      </p>
                    </Link>
                </div>
